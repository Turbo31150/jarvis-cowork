...
def main():
    parser = argparse.ArgumentParser(
        description="Lanceur intelligent d'applications Windows.")
    group = parser.add_mutually_exclusive_group(required=True)
    group.add_argument(
        "--list",
        action="store_true",
        help="Lister les applications connues")
    group.add_argument(
        "--running",
        action="store_true",
        help="Lister les applications connues qui sont déjà en cours")
    group.add_argument(
        "--launch",
        metavar="APP",
        help="Lancer ou focuser l'application donnée")
    group.add_argument(
        "--kill",
        metavar="APP",
        help="Arrêter l'application donnée")
