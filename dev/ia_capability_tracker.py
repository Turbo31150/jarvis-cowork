...
CAPABILITY_TESTS = [{"id": "code_gen",
                    ...
                    {"id": "translate",
                     ...
                     "category": "language"},
                    {"id": "summary",
                     "prompt": "Summarize in one sentence: Machine learning is a subset of AI that enables systems to learn from data.",
...
def do_assess():
    ...
    prev = db.execute(
        "SELECT total_score FROM runs ORDER BY ts DESC LIMIT 1").fetchone()
    regression = False
