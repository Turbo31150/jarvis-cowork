...
def do_scan():
    ...
    if not contrast:
        recommendations.append(
            "High contrast mode available for better readability")

    db.execute(
        "INSERT INTO scans (ts, dpi_scaling, cursor_size, high_contrast, narrator_active, score) VALUES (?,?,?,?,?,?)",
        (time.time(),
         dpi,
         cursor,
         int(contrast),
...
def main():
    parser = argparse.ArgumentParser(
        description="Windows Accessibility Enhancer")
    parser.add_argument(
        "--once",
        "--scan",
        action="store_true",
    ...
    parser.add_argument(
        "--contrast",
        action="store_true",
        help="Toggle contrast")
    parser.add_argument(
        "--narrator",
        action="store_true",
        help="Toggle narrator")
