...
def get_resolution() -> str:
    # Utilise les API Win32 via ctypes pour récupérer la résolution du
    # moniteur principal
...
def set_resolution(width: int, height: int):
    ...
    if result == DISP_CHANGE_SUCCESSFUL:
        ...
        print(
            f"[display_manager] Échec du changement de résolution (code {result}).")
...
def set_night_mode(enable: bool):
    ...
    try:
        ...
        print(
            f"[display_manager] Erreur lors du changement du mode nuit : {e}")
...
def parse_resolution(arg: str) -> tuple:
    ...
    if not m:
        raise argparse.ArgumentTypeError(
            "Le format doit être WxH, ex. 1920x1080")
    return int(m.group(1)), int(m.group(2))


def main():
    parser = argparse.ArgumentParser(
        description="Gestionnaire d'écran Windows (résolution, luminosité, mode nuit).")
    ...
    group.add_argument(
        ...
        metavar="WxH",
        help="Définir la résolution (ex: 1920x1080)")
    group.add_argument(
        "--brightness",
        type=int,
        metavar="N",
        help="Régler la luminosité (0‑100)")
    group.add_argument(
        "--night-mode",
        choices=[
            "on",
            "off"],
        help="Activer (on) ou désactiver (off) le mode nuit")
