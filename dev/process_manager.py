...
def list_processes():
    ...
    cmd = [
        "powershell.exe",
        "-Command",
        "Get-Process | Select-Object -Property Id, ProcessName, CPU, @{Name='MemoryMB';Expression={[math]::Round($_.WorkingSet64/1MB,1)}} | ConvertTo-Json -Depth 2"]
...
def main():
    parser = argparse.ArgumentParser(
        description="Windows Process Manager (list, kill, restart)")
    ...
    restart_parser.add_argument(
        "pid", type=int, help="Process ID to kill before restart")
    restart_parser.add_argument("exe_path",
                                help="Path to executable or command to launch")
